...
export const DEMO_PRESETS: DemoPreset[] = [
  {
    ...
    standards: [
      { id: '1', conc: '0.001', signals: '0.09, 0.10, 0.08' },
      { id: '2', conc: '0.003', signals: '0.12, 0.13, 0.11' },
      { id: '3', conc: '0.01', signals: '0.18, 0.19, 0.17' },
      { id: '4', conc: '0.03', signals: '0.31, 0.33, 0.29' },
      { id: '5', conc: '0.1', signals: '0.68, 0.71, 0.65' },
      { id: '6', conc: '0.3', signals: '1.38, 1.43, 1.34' },
      { id: '7', conc: '1', signals: '2.68, 2.75, 2.61' },
      { id: '8', conc: '3', signals: '3.88, 3.96, 3.80' },
      { id: '9', conc: '10', signals: '4.58, 4.66, 4.50' },
      { id: '10', conc: '30', signals: '4.88, 4.96, 4.80' },
      { id: '11', conc: '100', signals: '4.95, 5.03, 4.88' },
      { id: '12', conc: '300', signals: '4.98, 5.06, 4.90' },
    ]
  },
  {
